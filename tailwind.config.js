  ...
  theme: {
    extend: {
      colors: {
        ...
        gray: {
          850: '#1F2937', // Custom shade between 800 and 900
        },
      },
      typography: (theme) => ({
        DEFAULT: {
